...
from services import AWSServices, AWSTranscriber, OpenAITranscriber, TextSummarizer
...
if Config.TRANSCRIPTION_SERVICE == 'openai':
    ...
    audio_transcriber = OpenAITranscriber(Config.OPENAI_API_KEY)
else:  # default to AWS
    ...
    audio_transcriber = AWSTranscriber(aws_services)

...
from services import AWSServices, TranscriberFactory, TextSummarizer
...
transcriber_kwargs = {
    'aws_services': aws_services if Config.TRANSCRIPTION_SERVICE.lower() == 'aws' else None,
    'api_key': Config.OPENAI_API_KEY if Config.TRANSCRIPTION_SERVICE.lower() == 'openai' else None
}
audio_transcriber = TranscriberFactory.create_transcriber(Config.TRANSCRIPTION_SERVICE, **transcriber_kwargs)

...
GroupLang-secretary-bot is a Telegram bot that transcribes voice messages, summarizes the content, and allows users to tip for the service. The bot utilizes AWS services for transcription and employs a custom API for summarization. The bot is designed to be deployed as an AWS Lambda function.
...
2. Configure AWS credentials:
   - You can either set up the AWS CLI or use the environment variables as mentioned above

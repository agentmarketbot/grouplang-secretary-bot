import boto3
from typing import Optional, Tuple, Dict, Protocol, runtime_checkable
...
class AWSTranscriber(AudioTranscriber):
...
class OpenAITranscriber(AudioTranscriber):
    ...
    def transcribe_audio(self, file_url: str) -> str:
        try:
            ...
            temp_file = BytesIO(audio_content)
            temp_file.name = "audio.ogg"  # OpenAI needs a file name
